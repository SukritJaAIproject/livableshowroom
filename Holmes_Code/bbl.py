...
# output = change_bg.color_bg(r"C:\Users\sukri\PycharmProjects\opencv_gpu\nchn.jpg", colors = (0, 128, 0))
...
video = cv2.VideoCapture("ocean.mp4")
oceanVideo = cv2.VideoCapture(1)
