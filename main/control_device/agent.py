...
ACCESS_TOKEN = 'gAmeVYhTTyVdMuYcXVMc'
...
dqn.load_weights(r'C:\Users\EGAT\PycharmProjects\HC\model\Holmes_2564_04_27_intv2_change_reward.h5f')

while True:
    mode, fan, envTemp, envTempShow, tgtTemp, onoff = acvalues('node0rn5sn3feu38d5rbgx853kmgc3181.node0', 0)
    ...
    com = myagenttake(25, 'C82B962C7F5C', 'node0rn5sn3feu38d5rbgx853kmgc3181.node0')
